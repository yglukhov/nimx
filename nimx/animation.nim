...
template setInterpolationAnimation(a: Animation, ident: untyped, fromVal, toVal: untyped, body: typed): typed =
    let fv = fromVal
    let tv = toVal
...
macro animate*(a: Animation, what: untyped, how: typed): typed =
    let ident = what[1]
